...
const VALID_LOG_LEVELS = ['debug', 'error', 'warn', 'log', 'info'];
...
const parseConfig = () => {
    ...
    let rateLimitingWindow = DEFAULT_CONFIG.RATE_LIMITING_WINDOW;
    ...
    let redisPort = DEFAULT_CONFIG.REDIS_PORT;
    if (env.REDIS_PORT) {
    ...
    let jwtSecret = DEFAULT_CONFIG.JWT_SECRET;
    if (env.JWT_SECRET) {
